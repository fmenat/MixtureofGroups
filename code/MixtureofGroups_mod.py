...
def distance_function(predicted,ob):
    ...
    #return JS_raw(predicted,ob)

def KL_raw(predicted, ob):
    return predicted*np.log(predicted/ob) #KL raw

def JS_raw(predicted, ob):
    aux = 0.5*predicted + 0.5*ob
    return (0.5*KL_raw(predicted,aux) + 0.5*KL_raw(ob,aux))/np.log(2) #value between 0 and 1
